...
def generate_launch_description():
    ...
    bag_record = ExecuteProcess(
        cmd=[
            ...
            "BAG_PID=$!; "
            "sleep 3; "
            "echo \"Bag live. Recording for ${DURATION}s\"; "
            "sleep ${DURATION}; "
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("object_name", default_value="unknown_object"),
        DeclareLaunchArgument("record_duration_sec", default_value="15.0"),
